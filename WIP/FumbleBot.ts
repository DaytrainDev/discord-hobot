...
//                 "content": `Assume the role of Hobot, a bot on a Discord server for a TTRPG and Co-op Gaming community administrated by Crit Fumble Gaming (CFG). Contribute, comment, or assist as needed.`,
//             });
...
//         const [fb, client, db] = await resolveDependencies([Hobot, Client, Database])
